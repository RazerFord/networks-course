...
#### Демонстрация работы
Слева вывод клиента, справа - сервера
...
Реализация `checksum` лежит в файле [common](./stop-and-wait/internal/network/common/common.go#L310)
...
Тесты `checksum` лежат в файле [checksum_test](./stop-and-wait/test/checksum_test.go)
